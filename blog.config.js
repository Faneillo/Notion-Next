...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '183b7ee502f8803eb7e3e2960377e917',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Oliver Fan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个很爱瞎捣鼓的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.faneillo.online/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/Faneillo/Blog-Photos/refs/heads/main/IMG_0388.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    'Hi，我是Faneillo, Hi，我不是费列罗,欢迎来到我的博客🎉,玩的开心：）',
